...
To use the prediction script, follow these steps:

1. **Run the Prediction Script:**
   - Navigate to the project directory:
     ```bash
     cd traffic-management-system/src
     ```
   ...
   The script will automatically simulate the traffic and provide the prediction results.
